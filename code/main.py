...
if opt.epoch != 0:
    ...
    generator.load_state_dict(torch.load('/home/baba/Babajide_Research/EchoNus_project/gan_code/saved_model/%s/generator_%d.pth' % (opt.dataset_name, opt.epoch)))
    discriminator.load_state_dict(torch.load('/home/baba/Babajide_Research/EchoNus_project/gan_code/saved_model/%s/discriminator_%d.pth' % (opt.dataset_name, opt.epoch)))
else:
    # Initialize weights
...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    if opt.checkpoint_interval != -1 and epoch % opt.checkpoint_interval == 0:
        ...
        torch.save(generator.state_dict(), '/home/baba/Babajide_Research/EchoNus_project/gan_code/saved_model/%s/generator_%d.pth' % (opt.dataset_name, epoch))
        torch.save(discriminator.state_dict(), '/home/baba/Babajide_Research/EchoNus_project/gan_code/saved_model/%s/discriminator_%d.pth' % (opt.dataset_name, epoch))
